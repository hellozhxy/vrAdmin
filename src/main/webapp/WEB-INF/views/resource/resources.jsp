...
<body class="easyui-layout" data-options="border:false">
	...
	<div id="edit-video-window" class="easyui-dialog" closed="true" buttons="#edit-buttons" title="编辑窗口" style="width:700px;height:600px;">
		<div style="padding:20px 20px 40px 80px;">
			<form id='editForm' method="post">
				<table width="50%" cellpadding="0" cellspacing="0" style="table-layout:fixed">
						...
						<td>
							<div id="frame">
						      ...
						      <div class="resumable-drop" ondragenter="jQuery(this).addClass('resumable-dragover');" ondragend="jQuery(this).removeClass('resumable-dragover');" ondrop="jQuery(this).removeClass('resumable-dragover');">
						        <a class="resumable-browse" onchange="upload();"><u>select video from your computer</u></a>
						      </div>
