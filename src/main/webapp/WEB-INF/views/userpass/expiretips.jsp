...
<div class="login">
    <div class="msg">
        您的密码还有${expireDays}天到期,请尽快修改
    </div>
    <div class="btns">
        <a class="loginbtn" href="${url}" onclick="return doHref(this);">修改密码</a>
        <a style="margin-left: 5px;" href="/userpass/nextupdate" onclick="return doHref(this);">下次修改</a>
    </div>
